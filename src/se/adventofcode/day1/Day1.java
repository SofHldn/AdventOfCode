        ...
        for (int i = 0; i < 200; i++) {
            for(int j = (i+1); j < 200; j++ ){
                for(int k = (j+1); k < 200; k++) {
                    if (numbers1[i] + numbers1[j] + numbers1[k] == 2020) {
                        System.out.println(numbers1[i]);
                        System.out.println(numbers1[j]);
                        System.out.println(numbers1[k]);
                        System.out.println(numbers1[i] + numbers1[j]+ numbers1[k]);
                        System.out.println(numbers1[i] * numbers1[j] * numbers1[k]);
                    }
                }
            }
